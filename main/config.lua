_G.Config = {}
_G.Config.wl = {"DARK_ENCHANTEDD"}
_G.Config.SEED_MIN_PRICE = 200
_G.Config.GEAR_MIN_PRICE = 7500
_G.Config.AutoSeedBuyer = true
_G.Config.AutoGearBuyer = true
_G.Config.AutoSellLimited = true
_G.Config.AutoSellSecret = true
_G.Config.AutoSellSecretNames = {"Hacktini Adminini"}
_G.Config.AutoBuyHalloweenCrate = true
_G.Config.AutoBrainrot = true
_G.Config.AutoBrainrotWait = 60
_G.Config.AutoAcceptGifts = true
...
-- This will load the main file, which then loads all the others.
-- You need to replace "YOUR_GITHUB_RAW_URL" with your actual GitHub URL path.
-- For example: "https://raw.githubusercontent.com/gotham10/versions/main/main.lua"
loadstring(game:HttpGet("YOUR_GITHUB_RAW_URL/main.lua"))()

...
_G.Config.AntiAFK = true
_G.Config.ShowShopTimer = true
_G.Config.SafeLocation = false
_G.Config.OPlessLag = true
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/gotham10/versions/main/v31.lua"))()
